...
//  VegetationApp
//
//  Created by Nitin Bhatia on 16/04/19.
//  Copyright © 2019 Nitin Bhatia. All rights reserved.
//

import UIKit

protocol HazardTreeSortFilterDelegate{
    func setSortFilterValue(data:[String:Any])
}

class FilterVCHazardTree: UIViewController {
    
    //variables
    var filterFieldDelegate : HazardTreeSortFilterDelegate!
